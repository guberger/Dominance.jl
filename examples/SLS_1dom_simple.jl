...
circ = [matplotlib.lines.Line2D([0.0], [0.0], ls = "solid", c = _cols[i],
    marker = ".", ms = 10, mfc = _cols[i], mec = _cols[i]) for i = 1:2]
...
gs = matplotlib.gridspec.GridSpec(2, 2, figure = fig, wspace = 0.35,
    hspace = 0.15)
...
ax.plot(real.(ev1), imag.(ev1), clip_on = false, marker = ".", ms = 18,
    ls = "none", mfc = _cols[1], mec = "black", mew = 1.5,
...
LG = 0.9
ax.plot(LG*[-1.0, 1.0], LG*[-1.0, 1.0], ls = "solid", c = "blue", lw = 2.0,
    label = L"$A_1$")
ax.plot([0.0, 0.0], [-1.0, 1.0], ls = "dashed", c = "blue", lw = 2.0)
ax.plot(LG*[-1.0, 1.0], -LG*[-1.0, 1.0], ls = "solid", c = "red", lw = 2.0,
    label = L"$A_2$")
...
circ1 = matplotlib.lines.Line2D([0.0], [0.0], c = "blue", lw = 2.0,
    label = L"$A_1$")
circ2 = matplotlib.lines.Line2D([0.0], [0.0], c = "red", lw = 2.0,
    label = L"$A_2$")
...
fig.savefig("./figures/fig_SLS_1dom_simple_fragile_eigs_cones.png",
    transparent = false,
